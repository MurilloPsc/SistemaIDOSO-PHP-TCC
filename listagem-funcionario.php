...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td><?php echo $funcao[$linha['funcao']]; ?></td>
        <td><?php echo $linha['email']; ?></td>
        <td><?php echo $linha['senha']; ?></td>
        <td>
            <a href="editar-funcionario.php?id=<?php echo $linha['id']; ?>">Editar </a>
            <a href="javascript: if(confirm('Tem certeza que deseja deletar o usuário <?php echo $linha['nome_completo']; ?>'))
            location.href='deletar-funcionario.php?id=<?php echo $linha['id']; ?>';">Deletar </a>
        </td>
    </tr>
