...
<body>
    ...
    <section class="main-content">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card">
                    <h4 class="card-header">Incluir morador</h4>
                    <div class="card-body" >
                        <p class="card-text">Clique no botão abaixo para acessar a página de cadastro morador</p>
                        <a href="cadastropaciente.php" class="btn btn-primary">Inlcuir paciente</a>
                        <a href="listagem-paciente.php" class="btn btn-primary">Excluir paciente</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card">
                    <h4 class="card-header">Incluir funcionário</h4>
                    <div class="card-body">
                        <p class="card-text">Clique no botão abaixo para acessar a página de cadastro funcionário</p>
                        <a href="cadastrofuncionario.php" class="btn btn-primary">Incluir funcionário</a>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <h4 class="card-header">Incluir cliente</h4>
                    <div class="card-body">
                        <p class="card-text">Clique no botão abaixo para acessar a página de cadastro cliente</p>
                        <a href="cadastrocliente.php" class="btn btn-primary">Incluir cliente</a>
