<?php
    ...
    if(!isset($_GET['id_cliente']))
        ...
        $_SESSION[num_celu] = $linha['num_celu'];
        $_SESSION[tel_fixo] = $linha['num_celu'];
            ...
            <form style="margin: 1%;" action="editar-cliente.php?id_cliente=<?php echo $cliente_id?>" method="POST">
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nome_cliente" name="nome_cliente" value="<?php echo $_SESSION[nome_cliente]; ?>" required>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" class="form-control" id="data_nascimento" name="data_nascimento" value="<?php echo $_SESSION[data_nascimento]; ?>" require>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo $_SESSION[endereco]; ?>" required>
                    </div>
                    <div class="col-md-3 mb-1">
                        <label for="estado">Estado</label>
                        <input type="text" class="form-control" id="estado" name="estado" value="<?php echo $_SESSION[estado]; ?>" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="cidade">Cidade</label>
                        <input type="text" class="form-control" id="cidade" name="cidade" value="<?php echo $_SESSION[cidade]; ?>"  required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="rg" name="rg" value="<?php echo $_SESSION[rg]; ?>"  required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="cpf">CPF</label>
                        <input type="number" class="form-control" id="cpf" name="cpf" value="<?php echo $_SESSION[cpf]; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" id="num_celu" name="num_celu" value="<?php echo $_SESSION[num_celu]; ?>"  required>
                    </div>
                    <div class="col-md-3 mb-1">
                        <label for="validationDefault04">Telefone Fixo</label>
                        <input type="number" class="form-control" id="tel_fixo" name="tel_fixo" value="<?php echo $_SESSION[tel_fixo]; ?>">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="validationDefault05">Nome do paciente internado</label>
                        <input type="text" class="form-control" id="nome_paciente" name="nome_paciente" value="<?php echo $_SESSION[nome_paciente]; ?>">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="parentesco" name="parentesco" value="<?php echo $_SESSION[parentesco]; ?>">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="password" class="form-control" id="senha" name="senha" value="<?php echo $_SESSION[senha]; ?>">
                    </div>
