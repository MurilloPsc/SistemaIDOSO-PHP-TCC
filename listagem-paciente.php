...
<body>
        ...
        <div class="nano">
            <div class="nano-content">
                <ul class="metisMenu nav" id="menu">
                    ...
                    <li><a href="page-calendar.php"><i class="fa fa-calendar"></i> Historico paciente </a></li>
    ...
    <section class="main-content">
        ...
        <!--start page content-->
        <div class="row">
        <a href="cadastropaciente.php">Cadastrar</a>
 <p class=espaco></p>
...
<table>
    ...
    <tr>
        ...
        <td>
        <a href="editar-paciente.php?id_cliente=<?php echo $linha['id_paciente']; ?>">Editar </a>
            <a href="javascript: if(confirm('Tem certeza que deseja deletar o paciente <?php echo $linha['nome_paciente']; ?>'))
            location.href='deletar-paciente.php?id_paciente=<?php echo $linha['id_paciente']; ?>';">Deletar </a>
        </td>
    </tr>
