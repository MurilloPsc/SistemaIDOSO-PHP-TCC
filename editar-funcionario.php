<?php
    ...
    if(!isset($_GET['id']))
        echo "<script> alert('Codigo invalido.'); location.href='listagem-funcionario.php'; </script>";  
    else{
        ...
        if(strlen($_SESSION['senha']) == 0)
            $erro[] = "Preencha a senha corretamente";
             ...
             if(count($erro) == 0){
                ...
                $sql_code = "SELECT * FROM FUNCIONARIO WHERE id = '$funcionario_id'";
...
<body>
    ...
    <section class="main-content">
        ...
        ?>
            <form action="editar-funcionario.php?id=<?php echo $funcionario_id?>" method="POST">
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="nome_completo">Nome Completo</label>
                        <input type="text" class="form-control" name="nome_completo"  value="<?php echo $_SESSION[nome_completo]; ?>" required>
                    </div>
